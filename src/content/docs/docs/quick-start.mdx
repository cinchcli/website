...
1. **Install the Cinch app on your Mac**
   ...
   <Aside type="tip">
     On macOS and Linux, `ci` is installed as a short alias for `cinch` — every command on this page works under both names (`ci pull`, `ci send`, …). On Windows, use `cinch` directly.
   </Aside>
